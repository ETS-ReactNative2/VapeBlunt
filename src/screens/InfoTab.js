        ...
        if (options.length > 1) {
            return (
                <DropDownPicker
                    ...
                    onChangeItem={(item) =>
                        this.props.onVariantSelect(item.value)
                    }
                />
            );
        }
        ...
        return (
            <View style={{ paddingHorizontal: 20 }}>
                ...
                >
                    ...
                    <Text
                        style={{ fontSize: 16, width: 100, textAlign: "right" }}
                    >
                ...
                <View style={{ flexDirection: "row", marginVertical: 5 }}>
                    ...
                    {Array((rating / 0.5) % 2)
                        ...
                        .map((_, i) => (
                            <Image
                                key={i}
                                source={require("../assets/icons/star-medium.png")}
                                style={{ width: 16, height: 16 }}
                            />
                        ))}
                    {/* Render inactive stars */}
                    {Array(5 - Math.floor(rating) - ((rating / 0.5) % 2))
                        .fill()
                        .map((_, i) => (
                            <Image
                                key={i}
                                source={require("../assets/icons/star-inactive.png")}
                                style={{ width: 16, height: 16 }}
                            />
                        ))}
                </View>
                ...
                <View style={{ marginTop: 20 }}>{this.renderButtons()}</View>
            </View>
        );
    }
}
