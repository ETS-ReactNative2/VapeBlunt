...
import { ScrollView, SafeAreaView, View, StyleSheet, Keyboard} from 'react-native';
import Header from '../components/Header';
import ProductCard from '../components/ProductCard';
import { newProducts } from '../lib/graphql-shopify'
    ...
    render(){
        ...
        return(
            <SafeAreaView style={{ backgroundColor: 'black' }}>
                <Header onPress = {()=>{ navigation.navigate('Tienda') }} arrow searchBar text={'Nuevos Productos'}/>
